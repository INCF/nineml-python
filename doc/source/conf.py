...
authors = 'Andrew P. Davison Thomas G. Close, Mike Hull, and Eilif Muller'
...
htmlhelp_basename = base_filename
...
latex_documents = [
  ('index', '%s.tex' % base_filename, title, authors, 'manual'),
]
...
man_pages = [
    ('index', base_filename, title, [authors], 1)
]
...
texinfo_documents = [
  ('index', base_filename, title, authors,
   base_filename, 'One line description of project.', 'Miscellaneous'),
]
