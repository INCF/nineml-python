...
class ComponentTestCase(unittest.TestCase):
    ...
    def test_regime_transitions_with_target(self):
        ...
        u = nineml.Regime("dU/dt = -U", transitions=[
                          nineml.Transition("U+=10", condition="U>10", to="test")])
        assert list(u.transitions_with_target)

    def test_transition_construction(self):

        t = nineml.Transition(
            to=nineml.Reference(nineml.Regime, "test"), condition="V>10", do="V=10")
    ...
    def test_transition(self):
        ...
        e = nineml.Transition(
            "A+=10", condition="A>10", to=nineml.Reference(nineml.Regime, "test"))
        e = nineml.Transition(
            "A+=10", condition="A>10", to=nineml.Reference(nineml.Regime, "test"))
        ...
        self.assertRaises(ValueError, nineml.Transition, "A+=10",
                          condition="A>10", to=nineml.Reference(nineml.Transition, "test"))
