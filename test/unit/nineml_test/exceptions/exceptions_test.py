...
class Testinternal_error(unittest.TestCase):
...
# Testing Skeleton for function:
class Testraise_exception(unittest.TestCase):
...
# Testing Skeleton for class: NineMLRuntimeError
class NineMLRuntimeError_test(unittest.TestCase):
