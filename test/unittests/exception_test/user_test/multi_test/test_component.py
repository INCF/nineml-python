...
class TestMultiDynamicsExceptions(unittest.TestCase):
    ...
    def __init__(self, name, sub_components, port_connections=[],
        ...
        multidynamics = next(iter(instances_of_all_types['MultiDynamics'].values()))
        self.assertRaises(
            NineMLRuntimeError,
...
class Test_MultiRegimeExceptions(unittest.TestCase):
    ...
    def on_event(self, port_name):
        ...
        _multiregime = next(iter(instances_of_all_types['_MultiRegime'].values()))
        self.assertRaises(
            KeyError,
...
class Test_MultiTransitionExceptions(unittest.TestCase):
    ...
    def __init__(self, sub_transitions, parent):
        ...
        _multitransition = next(iter(instances_of_all_types['_MultiTransition'].values()))
        self.assertRaises(
            NineMLRuntimeError,
...
class TestSubDynamicsPropertiesExceptions(unittest.TestCase):
    ...
    def initial_value(self, name):
        ...
        subdynamicsproperties = next(iter(instances_of_all_types['SubDynamicsProperties'].values()))
        self.assertRaises(
            KeyError,
