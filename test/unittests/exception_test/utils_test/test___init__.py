...
from nineml.utils.__init__ import (
    ...
    check_inferred_against_declared, safe_dict, safe_dict, ensure_iterable,
...
def flatten_first_level(nested_list):
    ...
    @unittest.skip('Skipping autogenerated unittest skeleton')
    def test_check_inferred_against_declared_ninemlruntimeerror(self):
        """
        line #: 437
        message: errmsg
        ...
        context:
        --------
def check_inferred_against_declared(lst1, lst2, desc1="", desc2="", ignore=[],
                                  desc=""):
    set1 = set(lst1)
    set2 = set(lst2)
    for i in ignore:
