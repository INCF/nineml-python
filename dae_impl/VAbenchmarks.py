...
connections['e2e'].saveConnections('n2000/e2e.conn')
connections['e2i'].saveConnections('n2000/e2i.conn')
connections['i2e'].saveConnections('n2000/i2e.conn')
connections['i2i'].saveConnections('n2000/i2i.conn')
if (benchmark == "COBA"):
    connections['ext2e'].saveConnections('n2000/ext2e.conn')
    connections['ext2i'].saveConnections('n2000/ext2i.conn')
